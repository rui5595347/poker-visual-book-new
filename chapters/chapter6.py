...
# 注意所有ID前缀chapter6-，避免与前几章冲突！
layout = html.Div([
    html.H2("Chapter 6: Bluffing Skills & Frequency Control", style={'marginTop': '24px', 'marginBottom': '8px'}),
    html.Div(
    ...
    html.Div([
        ...
        html.Span([
            ...
            "The optimal bluffing frequency (GTO) is determined by your bet size—bigger bets need a higher bluff ratio to keep opponents guessing."
        ])
    ], style={'background': '#f2fbf2', 'borderLeft': '5px solid #43A047', 'padding': '14px 16px', 'borderRadius': '8px', 'marginBottom': '28px'}),
    html.Div([
    ...
    html.Div([
        ...
        "Even with mathematically balanced frequencies, some bluffs will inevitably get caught! Don't be discouraged—focus on managing your emotions and bankroll. ",
        html.Span("Up next: learn how to handle variance and build mental resilience in the final chapter.", style={'color': '#388e3c', 'fontWeight': 'bold'})
...
], style={'maxWidth': '650px', 'margin': '0 auto', 'padding': '36px 10px 20px 10px', 'fontFamily': 'system-ui'})
...
def register_callbacks(app):
    ...
    def update_bluff_pie(bet_pot_ratio):
        ...
        colors = ['#43A047', '#E53935']  # 色盲友好绿色/红色
